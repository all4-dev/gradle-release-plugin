 ...
 * ```
 */
public object OnePasswordSupport {
     ...
     */
    public fun resolve(value: String, project: Project): String {
     ...
     */
    public fun resolveOrNull(value: String?, project: Project): String? {
     ...
     */
    public fun loadFromEnvironment(prefix: String, project: Project): Map<String, String> {
     ...
     */
    public fun getUsageHelp(): String = """
        |
 ...
 */
public fun Project.resolveSecret(propertyName: String): String? {
 ...
 */
public fun Provider<String>.resolve1Password(project: Project): Provider<String> {
